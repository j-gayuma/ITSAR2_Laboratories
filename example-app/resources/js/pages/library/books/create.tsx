...
export default function BookCreate({ categories }: BookCreateProps) {
    ...
    return (
        <LibraryLayout title="Add a Book">
            <Link
                href="/library"
            ...
            <h1 className="mb-8 text-3xl font-bold text-gray-900">Add a New Book</h1>
